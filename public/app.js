...
function renderProfile(){
  ...
  h+=`<div class="card"><div class="label">Your Plan</div><div class="text-sm mb-8">6-Day PPL x2 \u00B7 Push/Pull/Legs repeated twice per week</div><div class="text-xs text-dim">Tue: Push A \u00B7 Wed: Pull A \u00B7 Thu: Legs A</div><div class="text-xs text-dim">Fri: Push B \u00B7 Sat: Pull B \u00B7 Sun: Legs B \u00B7 Mon: Rest</div><div class="text-xs text-dim mt-8">Plan: March 10 - June 2, 2026</div><div class="tip tip-red mt-8"><b>Medical:</b> L4-L5 disc bulge + cervical spine. All exercises spine-safe. No RDL. No cardio on leg days. See Medical tab for full details.</div></div>`;
