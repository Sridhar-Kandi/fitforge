...
function renderToday(){
  ...
  if(!di){h+=`<div class="empty-state"><div class="e-icon">\u{1F4CB}</div><p>No workout today or outside plan range (Mar 11 - Jun 3, 2026).</p></div>`;}
...
function renderProfile(){
  ...
  h+=`<div class="card"><div class="label">Your Plan</div><div class="text-sm mb-8">6-Day PPL x2 \u00B7 Legs-Push-Pull repeated twice per week</div><div class="text-xs text-dim">Wed: Legs A \u00B7 Thu: Push A \u00B7 Fri: Pull A</div><div class="text-xs text-dim">Sat: Legs B \u00B7 Sun: Push B \u00B7 Mon: Pull B \u00B7 Tue: Rest</div><div class="text-xs text-dim mt-8">Plan: March 11 - June 3, 2026</div><div class="tip tip-red mt-8"><b>Medical:</b> L4-L5 disc bulge + cervical spine. All exercises spine-safe. No RDL. No cardio on leg days. See Medical tab for full details.</div></div>`;
